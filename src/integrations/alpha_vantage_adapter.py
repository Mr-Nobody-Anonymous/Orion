"""
Orion Data Provider Adapter for alpha_vantage
Source: https://github.com/RomelTorres/alpha_vantage.git
"""
...
class AlphaVantageDataAdapter:
    """
    Data provider adapter for alpha_vantage.
